        ...
        <main className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden bg-background">
            ...
            >
                <motion.div 
                    ...
                    className="w-16 h-16 rounded-2xl bg-emerald-500/10 flex items-center justify-center mb-6 border border-emerald-500/30 rotate-3"
                >
                ...
                <p className="text-muted-foreground text-base sm:text-lg mb-10 max-w-lg mx-auto">
                    {es 
                        ? "Parece que te has topado con un error 404. El componente que buscas no existe o ha sido refactorizado." 
                        : "It seems you've hit a 404 error. The component you are looking for doesn't exist or has been refactored."}
                </p>
                ...
                <motion.div 
                    ...
                    className="bg-foreground/[0.03] border border-border/50 rounded-xl p-5 sm:p-6 mb-10 w-full max-w-md text-left font-mono text-sm sm:text-base overflow-hidden relative shadow-inner mx-auto"
                >
                ...
                >
                    ...
                    <Button asChild variant="outline" size="lg" className="rounded-full w-full sm:w-auto px-8 border-border hover:bg-foreground/5">
                        <Link href="/#projects">
