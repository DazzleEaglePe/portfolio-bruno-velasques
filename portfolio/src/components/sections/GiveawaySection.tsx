                            ...
                            <div className="p-8 md:p-10 flex flex-col justify-center">
                                {loading ? (
                                    ...
                                    <div className="flex flex-col items-center text-center gap-5">
                                        ...
                                        <div>
                                            <h4 className="text-lg font-bold mb-1">{t("giveaway.section.registered")}</h4>
                                        ...
                                        {/* Position Badge */}
                                        {entryPosition && (
                                            <Badge variant="secondary" className="rounded-full px-4 py-1.5 text-sm font-mono">
                                                {t("giveaway.section.position")} #{entryPosition} {t("giveaway.section.of")} {participantCount}
                                            </Badge>
                                        )}
